...
extern Scene scenes_data[12];
extern float keyframe_data[994];
extern Sequence sequence_data[175];
extern int sequence_index[88];
extern int keyframe_index[88];
extern Uniform uniforms[87];
extern float keyframe_time[408];
extern int keyframe_time_index[88];
#endif
