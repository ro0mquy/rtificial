...
extern float keyframe_data[909];
extern Sequence sequence_data[156];
extern int sequence_index[86];
extern int keyframe_index[86];
extern Uniform uniforms[85];
extern float keyframe_time[365];
extern int keyframe_time_index[86];
#endif
