#ifndef ao_blur_h_H
#define ao_blur_h_H
const char ao_blur_h_source[] =R"shader_source(#version 430
)shader_source"
...
R"shader_source(vec2 blurDirection = vec2(1, 0);
)shader_source"
...
R"shader_source(layout(binding = 9) uniform sampler2D ao; // float
)shader_source"
