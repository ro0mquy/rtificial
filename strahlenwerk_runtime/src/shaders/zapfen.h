...
layout(location = 72) uniform vec3 background_color; // color
layout(location = 73) uniform float zapfen_kreise;
layout(location = 74) uniform float zapfen_leit_freq;
layout(location = 75) uniform vec3 zapfen_color1; // color
layout(location = 76) uniform vec3 zapfen_color2; // color
layout(location = 77) uniform float zapfen_mat_freq;
layout(location = 78) uniform float zapfen_rough1;
layout(location = 79) uniform float zapfen_rough2;

layout(location = 80) uniform vec3 zapfen_light1_pos;
layout(location = 81) uniform vec3 zapfen_light2_pos;
layout(location = 82) uniform vec3 zapfen_light1_col; // color
layout(location = 83) uniform vec3 zapfen_light2_col; // color
layout(location = 84) uniform float zapfen_light_radius;
layout(location = 85) uniform float zapfen_light_intensity;
