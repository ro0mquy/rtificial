...
R"shader_source(layout(location = 232) uniform float kpd_raum_glow_intensity_rt_float;
)shader_source"
R"shader_source(layout(location = 233) uniform float kpd_raum_glow_falloff_rt_float;
)shader_source"
R"shader_source(layout(location = 137) uniform float kpd_blubber_smooth_rt_float;
)shader_source"
R"shader_source(layout(location = 138) uniform float kpd_blubber_rot_rt_float;
)shader_source"
R"shader_source(layout(location = 139) uniform vec3 kpd_blubber_pos_rt_vec3;
)shader_source"
R"shader_source(layout(location = 140) uniform float kpd_blubber_r_big_rt_float;
)shader_source"
R"shader_source(layout(location = 141) uniform float kpd_retweto_scale_inner_rt_float;
)shader_source"
R"shader_source(layout(location = 142) uniform float kpd_retweto_scale_outer_rt_float;
)shader_source"
R"shader_source(layout(location = 234) uniform float kpd_retweto_glider_glow_intensity_rt_float;
)shader_source"
R"shader_source(layout(location = 144) uniform float kpd_locopyr_welle_amp_rt_float;
)shader_source"
R"shader_source(layout(location = 143) uniform float kpd_locopyr_welle_width_rt_float;
)shader_source"
R"shader_source(layout(location = 145) uniform vec2 kpd_blubber_r_small_rt_vec2;
)shader_source"
R"shader_source(layout(location = 146) uniform float kpd_locopyr_domrep_rt_float;
)shader_source"
R"shader_source(layout(location = 147) uniform float tweto_tor_r_small_rt_float;
)shader_source"
R"shader_source(layout(location = 148) uniform float tweto_tor_num_twists_rt_float;
)shader_source"
R"shader_source(layout(location = 149) uniform vec2 kpd_locopyr_dim_rt_vec2;
)shader_source"
...
R"shader_source(layout(location = 150) uniform float kpd_locopyr_rounded_rt_float;
)shader_source"
R"shader_source(layout(location = 151) uniform float kpd_raum_angle_rt_float;
)shader_source"
R"shader_source(layout(location = 152) uniform float kpd_retweto_pos_y_rt_float;
)shader_source"
R"shader_source(layout(location = 153) uniform float kpd_raum_ground_rt_float;
)shader_source"
R"shader_source(layout(location = 154) uniform vec2 kpd_raum_groundhole_dim_rt_vec2;
)shader_source"
R"shader_source(layout(location = 155) uniform vec3 kpd_raum_trans_rt_vec3;
)shader_source"
R"shader_source(layout(location = 156) uniform float kpd_raum_loco_angle_rt_float;
)shader_source"
R"shader_source(layout(location = 157) uniform float kpd_locopyr_welle_velo_rt_float;
)shader_source"
R"shader_source(layout(location = 158) uniform float kpd_raum_h_rt_float;
)shader_source"
R"shader_source(layout(location = 159) uniform float tweto_glider_r_small_rt_float;
)shader_source"
R"shader_source(layout(location = 160) uniform float kpd_locopyr_welle_spacing_rt_float;
)shader_source"
R"shader_source(layout(location = 161) uniform float tweto_tor_r_big_rt_float;
)shader_source"
R"shader_source(layout(location = 162) uniform float kpd_blubber_r_rounded_rt_float;
)shader_source"
R"shader_source(layout(location = 65) uniform float camera_shake_freq_rt_float;
)shader_source"
R"shader_source(layout(location = 163) uniform float tweto_glider_r_big_rt_float;
)shader_source"
...
R"shader_source(const float id_raum = 0.;
)shader_source"
R"shader_source(const float id_raum_boden = 1.;
)shader_source"
R"shader_source(const float id_raum_groundhole = 2.;
)shader_source"
R"shader_source(const float id_retweto_big_torus = 4.;
)shader_source"
R"shader_source(const float id_retweto_big_glider = 5.;
)shader_source"
R"shader_source(const float id_retweto_small_torus = 6.;
)shader_source"
R"shader_source(const float id_retweto_small_glider = 7.;
)shader_source"
R"shader_source(const float id_blubberbrunnen = 8.;
)shader_source"
R"shader_source(const float id_blubberbrunnen_smooth = 9.;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(layout(location = 164) uniform float kpd_anim;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(const float kpd_blubber_loco_angle = -kpd_anim;
)shader_source"
R"shader_source(const float kpd_locopyr_rot = .5 * kpd_anim;
)shader_source"
R"shader_source(const float kpd_raum_loco_rot = kpd_anim;
)shader_source"
R"shader_source(const float kpd_tweto_loco_angle = -.5 * kpd_anim;
)shader_source"
R"shader_source(const float tweto_glider_rotation = kpd_anim;
)shader_source"
R"shader_source(const float tweto_tor_rotation = -kpd_anim;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(float fTotwi(vec3 p, float rBig, float rSmall) {
)shader_source"
R"shader_source(	vec2 q = vec2(f2Sphere(p.xz, rBig), p.y);
)shader_source"
R"shader_source(	pRot(q, Tau * kpd_locopyr_rot);
)shader_source"
R"shader_source(	return f2BoxRounded(q, vec2(1., .5) * rSmall, kpd_locopyr_rounded_rt_float);
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(MatWrap wPyramidLoco(vec3 p, float height, float angle) {
)shader_source"
R"shader_source(	pMirrorLoco(p.zx, vec2(sin(angle) * height));
)shader_source"
R"shader_source(	pRotX(p, -angle);
)shader_source"
R"shader_source(	/*
)shader_source"
R"shader_source(	pDomrepMirror(p.x, kpd_locopyr_domrep_rt_float);
)shader_source"
R"shader_source(	pRotY(p, Tau * kpd_locopyr_rot);
)shader_source"
R"shader_source(	float f = f2BoxRounded(p.xz, kpd_locopyr_dim_rt_vec2, kpd_locopyr_rounded_rt_float);
)shader_source"
R"shader_source(	// */
)shader_source"
R"shader_source(	/*
)shader_source"
R"shader_source(	pDomrep(p.xy, vec2(kpd_locopyr_domrep_rt_float));
)shader_source"
R"shader_source(	float f = -p.z;
)shader_source"
R"shader_source(	p.z -= kpd_locopyr_dim_rt_vec2.y;
)shader_source"
R"shader_source(	f = smin(f, fTotwi(p.xzy, kpd_locopyr_dim_rt_vec2.x, kpd_locopyr_dim_rt_vec2.y), .5);
)shader_source"
R"shader_source(	// */
)shader_source"
R"shader_source(	float spacing = kpd_locopyr_welle_spacing_rt_float;
)shader_source"
R"shader_source(	float r = length(p.xy) - spacing * kpd_anim * kpd_locopyr_welle_velo_rt_float;
)shader_source"
R"shader_source(	pDomrep(r, spacing);
)shader_source"
R"shader_source(	float t_welle = iqCubicPulse(0., kpd_locopyr_welle_width_rt_float, r);
)shader_source"
R"shader_source(	float f = -p.z - kpd_locopyr_welle_amp_rt_float * t_welle;
)shader_source"
R"shader_source(	return MatWrap(f, MaterialId(id_raum, p, vec4(t_welle, 0., 0., 0.)));
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(MatWrap wRaum(vec3 p) {
)shader_source"
R"shader_source(	// boden
)shader_source"
R"shader_source(	float f_boden = p.y - kpd_raum_ground_rt_float;
)shader_source"
R"shader_source(	MatWrap w_boden = MatWrap(f_boden, newMaterialId(id_raum_boden, p));
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	// ringgraben
)shader_source"
R"shader_source(	vec3 p_groundhole = p;
)shader_source"
R"shader_source(	p_groundhole.y -= kpd_raum_ground_rt_float;
)shader_source"
R"shader_source(	float f_groundhole = fHexprismEdge(p_groundhole, kpd_raum_groundhole_dim_rt_vec2.x, kpd_raum_groundhole_dim_rt_vec2.y);
)shader_source"
R"shader_source(	vec2 q_groundhole = vec2(f_groundhole, p_groundhole.y);
)shader_source"
R"shader_source(	pMirrorLoco(q_groundhole, vec2(0.));
)shader_source"
R"shader_source(	pRot(q_groundhole, Tau * kpd_raum_loco_rot);
)shader_source"
R"shader_source(	f_groundhole = f2BoxEdge(q_groundhole, 1.);
)shader_source"
R"shader_source(	MatWrap w_groundhole = MatWrap(f_groundhole, newMaterialId(id_raum_groundhole, p_groundhole));
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	// loco raum
)shader_source"
R"shader_source(	p.y -= 50.;
)shader_source"
R"shader_source(	pMirrorLoco(p.zyx, kpd_raum_trans_rt_vec3.yzx);
)shader_source"
R"shader_source(	pMirrorTrans(p, kpd_raum_trans_rt_vec3);
)shader_source"
R"shader_source(	pRotY(p, Tau * kpd_raum_loco_angle_rt_float);
)shader_source"
R"shader_source(	MatWrap w_raum = wPyramidLoco(p, kpd_raum_h_rt_float, Tau * kpd_raum_angle_rt_float);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	w_raum = mUnion(w_raum, w_boden);
)shader_source"
R"shader_source(	w_raum = mSubtract(w_raum, w_groundhole);
)shader_source"
R"shader_source(	return w_raum;
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(MatWrap wTweto(vec3 p, float scale, float my_id_torus, float my_id_glider) {
)shader_source"
R"shader_source(	vec3 p_tor = p;
)shader_source"
R"shader_source(	// bounding torus
)shader_source"
R"shader_source(	float f_torus = fTorus(p_tor, tweto_tor_r_big_rt_float * scale, tweto_tor_r_small_rt_float * scale);
)shader_source"
R"shader_source(	MatWrap w_torus = MatWrap(f_torus, newMaterialId(my_id_torus, p_tor));
)shader_source"
R"shader_source(	if (w_torus.f < 1) {
)shader_source"
R"shader_source(		float r_tor = length(p_tor.xz) - tweto_tor_r_big_rt_float * scale;
)shader_source"
R"shader_source(		float angle_tor = atan(p_tor.z, p_tor.x);
)shader_source"
R"shader_source(		vec2 q_tor = vec2(r_tor, p_tor.y);
)shader_source"
R"shader_source(		pRot(q_tor, angle_tor / 4. * tweto_tor_num_twists_rt_float + Tau * tweto_tor_rotation);
)shader_source"
R"shader_source(		pMirrorLoco(q_tor, vec2(0.));
)shader_source"
R"shader_source(		pRot(q_tor, Tau * kpd_tweto_loco_angle);
)shader_source"
R"shader_source(		w_torus.f = f2Box(q_tor, vec2(.5, 1.) * tweto_tor_r_small_rt_float * scale);
)shader_source"
R"shader_source(		w_torus.m.coord = vec3(q_tor, angle_tor);
)shader_source"
R"shader_source(	}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	// glider
)shader_source"
R"shader_source(	vec3 p_glider = p;
)shader_source"
R"shader_source(	pRotY(p_glider, Tau * tweto_glider_rotation);
)shader_source"
R"shader_source(	p_glider.x -= tweto_tor_r_big_rt_float * scale;
)shader_source"
R"shader_source(	pRotZ(p_glider, Tau / 8. + Tau * tweto_tor_rotation - Tau * tweto_glider_rotation / 4. * tweto_tor_num_twists_rt_float);
)shader_source"
R"shader_source(	pMirrorTrans(p_glider.xy, vec2(tweto_glider_r_big_rt_float * tweto_tor_r_small_rt_float * sqrt(.5) * scale));
)shader_source"
R"shader_source(	float f_glider = fSphere(p_glider, tweto_glider_r_small_rt_float * scale);
)shader_source"
R"shader_source(	MatWrap w_glider = MatWrap(f_glider, newMaterialId(my_id_glider, p_glider));
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	return mUnion(w_torus, w_glider);
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(MatWrap wRetweto(vec3 p) {
)shader_source"
R"shader_source(	// big torus
)shader_source"
R"shader_source(	p.y -= kpd_retweto_pos_y_rt_float;
)shader_source"
R"shader_source(	vec3 p_big = p;
)shader_source"
R"shader_source(	MatWrap w_big = wTweto(p_big, kpd_retweto_scale_outer_rt_float, id_retweto_big_torus, id_retweto_big_glider);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	// small tori
)shader_source"
R"shader_source(	vec3 p_small = p_big;
)shader_source"
R"shader_source(	pRotY(p_small, Tau / 6.);
)shader_source"
R"shader_source(	pDomrepAngle(p_small.xz, 6., 0.);
)shader_source"
R"shader_source(	p_small.x -= tweto_tor_r_big_rt_float * kpd_retweto_scale_outer_rt_float;
)shader_source"
R"shader_source(	p_small.z = -p_small.z;
)shader_source"
R"shader_source(	float small_scale = kpd_retweto_scale_inner_rt_float * kpd_retweto_scale_outer_rt_float;
)shader_source"
R"shader_source(	MatWrap w_small = wTweto(p_small.xzy, small_scale, id_retweto_small_torus, id_retweto_small_glider);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	return mUnion(w_big, w_small);
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(MatWrap wBlubberbrunnen(vec3 p, float r) {
)shader_source"
R"shader_source(	pMirrorLoco(p.zyx, vec3(r * kpd_blubber_r_big_rt_float));
)shader_source"
R"shader_source(	pRotX(p, Tau * kpd_blubber_loco_angle);
)shader_source"
R"shader_source(	float f_blubber = f2BoxRounded(p.yz, vec2(r * kpd_blubber_r_small_rt_vec2), r * kpd_blubber_r_rounded_rt_float);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	return MatWrap(f_blubber, newMaterialId(id_blubberbrunnen, p));
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(MatWrap wAlleBlubberbrunnen(vec3 p) {
)shader_source"
R"shader_source(	pMirrorTrans(p.xz, kpd_blubber_pos_rt_vec3.xz);
)shader_source"
R"shader_source(	p.y -= kpd_blubber_pos_rt_vec3.y;
)shader_source"
R"shader_source(	pRotY(p, Tau * kpd_blubber_rot_rt_float);
)shader_source"
R"shader_source(	MatWrap w_alle = wBlubberbrunnen(p, 1.);
)shader_source"
R"shader_source(	return w_alle;
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
...
R"shader_source(	// loco raum & ground
)shader_source"
R"shader_source(	MatWrap w_raum = wRaum(p);
)shader_source"
R"shader_source(	mUnion(w_raum.f, w_raum.m);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	// brunnen
)shader_source"
R"shader_source(	MatWrap w_blubberbrunnen = wAlleBlubberbrunnen(p);
)shader_source"
R"shader_source(	mUnionSmooth(w_blubberbrunnen.f, w_blubberbrunnen.m, kpd_blubber_smooth_rt_float, id_blubberbrunnen_smooth);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	// central recursive tweto thingie
)shader_source"
R"shader_source(	MatWrap w_retweto = wRetweto(p);
)shader_source"
R"shader_source(	mUnion(w_retweto.f, w_retweto.m);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	/*
)shader_source"
R"shader_source(	float f = fRaum(p);
)shader_source"
R"shader_source(	f = opUnionSmooth(f, fAlleBlubberbrunnen(p), kpd_blubber_smooth_rt_float);
)shader_source"
R"shader_source(	f = min(f, fRetweto(p));
)shader_source"
R"shader_source(	// */
)shader_source"
R"shader_source(
...
R"shader_source(	vec3 ekelhaft = vec3(38,62,54)/255.;
)shader_source"
R"shader_source(	vec3 lets_celebrate = vec3(49,90,85)/255.;
)shader_source"
R"shader_source(	vec3 blue = vec3(26,76,107)/255.;
)shader_source"
R"shader_source(	vec3 egeagb = vec3(59,121,165)/255.;
)shader_source"
R"shader_source(	vec3 arista = vec3(108,97,125)/255.;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	if (materialId.id == id_retweto_small_torus) {
)shader_source"
R"shader_source(		vec2 p_torbox = abs(materialId.coord.xy);
)shader_source"
R"shader_source(		// different colors for different sides of cube
)shader_source"
R"shader_source(		if (2. * p_torbox.x > p_torbox.y) {
)shader_source"
R"shader_source(			mat.color = ekelhaft;
)shader_source"
R"shader_source(		} else {
)shader_source"
R"shader_source(			mat.color = blue;
)shader_source"
R"shader_source(		}
)shader_source"
R"shader_source(	} else if (materialId.id == id_retweto_big_torus) {
)shader_source"
R"shader_source(		mat.color = blue;
)shader_source"
R"shader_source(	} else if (materialId.id == id_raum) {
)shader_source"
R"shader_source(		mat.color = lets_celebrate;
)shader_source"
R"shader_source(		float t_glow = pow(materialId.misc.x, kpd_raum_glow_falloff_rt_float);
)shader_source"
R"shader_source(		t_glow *= iqPowerCurve(3., 23., min(.5, fract(kpd_anim)) * 2.);
)shader_source"
R"shader_source(		mat.emission = vec3(1.) * 1000. * t_glow * kpd_raum_glow_intensity_rt_float;
)shader_source"
R"shader_source(	} else if (materialId.id == id_blubberbrunnen) {
)shader_source"
R"shader_source(		mat.color = egeagb;
)shader_source"
R"shader_source(	} else if (materialId.id == id_blubberbrunnen_smooth) {
)shader_source"
R"shader_source(		mat.color = blue;
)shader_source"
R"shader_source(	} else if (materialId.id == id_raum_boden) {
)shader_source"
R"shader_source(		mat.color = arista;
)shader_source"
R"shader_source(	} else if (materialId.id == id_raum_groundhole) {
)shader_source"
R"shader_source(		mat.color = ekelhaft;
)shader_source"
R"shader_source(	} else if (materialId.id == id_retweto_small_glider) {
)shader_source"
R"shader_source(		float t_glow = iqPowerCurve(3., 23., min(.5, fract(.5 + kpd_anim)) * 2.);
)shader_source"
R"shader_source(		mat.emission = vec3(1.) * 1000. * t_glow * kpd_retweto_glider_glow_intensity_rt_float;
)shader_source"
R"shader_source(	}
)shader_source"
R"shader_source(
