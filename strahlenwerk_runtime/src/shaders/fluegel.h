#ifndef fluegel_H
#define fluegel_H
const char fluegel_source[] =R"shader_source(#version 430
)shader_source"
R"shader_source(layout(location = 109) uniform float fluegel_domrep_rt_float;
)shader_source"
...
R"shader_source(	vec3 p_filling = p;
)shader_source"
...
R"shader_source(	phi += pow(r, .4) * 2.;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	//float dr_phi = fluegel_domrep_rt_float;
)shader_source"
...
R"shader_source(	p_filling.y -= fluegel_domrep_rt_float * .5;
)shader_source"
R"shader_source(	p_filling.z -= fluegel_domrep_rt_float * .5;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	p_filling.xz = domrep(p_filling.xz, vec2(fluegel_domrep_rt_float));
)shader_source"
R"shader_source(	//p_filling = domrep(p_filling, vec3(fluegel_domrep_rt_float));
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	float f_filling = box2(p_filling.xz, 1.*vec2(.01, .05));
)shader_source"
R"shader_source(	//float f_filling = box(p_filling, 1.*vec3(.01, .01, .03));
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	float d = max(d_fluegel, f_filling);
)shader_source"
R"shader_source(	//d = f_filling;
)shader_source"
R"shader_source(
)shader_source"
