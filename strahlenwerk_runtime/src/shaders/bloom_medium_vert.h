#ifndef bloom_medium_vert_H
#define bloom_medium_vert_H
const char bloom_medium_vert_source[] =R"shader_source(#version 430
)shader_source"
R"shader_source(
)shader_source"
...
R"shader_source(layout(binding = 0) uniform sampler2D color; // vec3 level(3)
)shader_source"
...
R"shader_source(	out_color = gaussian(color, tc, vec2(0., 1.), 1./res, 2.);
)shader_source"
R"shader_source(}
)shader_source"
;
