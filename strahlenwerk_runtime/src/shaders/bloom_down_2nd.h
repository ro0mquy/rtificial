#ifndef bloom_down_2nd_H
#define bloom_down_2nd_H
const char bloom_down_2nd_source[] =R"shader_source(#version 430
)shader_source"
R"shader_source(
)shader_source"
...
R"shader_source(layout(binding = 8) uniform sampler2D color; // vec3
)shader_source"
