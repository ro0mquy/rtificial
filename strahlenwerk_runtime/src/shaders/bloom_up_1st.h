...
const char bloom_up_1st_source[] =#version 430
...
#line 5
layout((binding=14))uniform sampler2D l;layout((binding=26))uniform sampler2D z;layout((location=0))out vec3 n;void main(){n=d(l,v,1./f)+textureLod(z,v,0.).xyz;};
#endif
