#ifndef bloom_up_6th_H
#define bloom_up_6th_H
const char bloom_up_6th_source[] =R"shader_source(#version 430
)shader_source"
...
R"shader_source(layout(binding=19)uniform sampler2D l;layout(binding=21)uniform sampler2D z;layout(location=0)out vec3 n;void main(){n=d(l,v,1./f)+textureLod(z,v,0.).xyz;}
)shader_source";
#endif
