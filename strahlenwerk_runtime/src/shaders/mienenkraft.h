...
R"shader_source(const float mk_hintergrund_kristall_h_rt_float = 40;
)shader_source"
R"shader_source(const float mk_bounding_offset_rt_float = 3;
)shader_source"
R"shader_source(const float mk_bounding_height_rt_float = 20;
)shader_source"
R"shader_source(const vec3 mk_kristall_pos_rt_vec3 = vec3(8.4750000000000227374, 7.5980000000000700311, 8.6660000000000536602);
)shader_source"
...
R"shader_source(const float mk_hintergrund_kristall_cap_rt_float = 4.415000000000077307;
)shader_source"
...
R"shader_source(const float kristAlle_id = 4.;
)shader_source"
R"shader_source(const float kristall2_id = 5.;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(vec3 p_kristall;
)shader_source"
R"shader_source(
)shader_source"
...
R"shader_source(	float t = march(o, d, 300., screenDist);
)shader_source"
R"shader_source(
)shader_source"
...
R"shader_source(	vec3 sky_color = environmentColor(o, d, 300.);
)shader_source"
R"shader_source(	if (isinf(t)) {
)shader_source"
R"shader_source(		out_color.rgb = sky_color;
)shader_source"
R"shader_source(	} else {
)shader_source"
...
R"shader_source(		if (material_id == kristall_id || material_id == kristall2_id) {
)shader_source"
R"shader_source(			vec3 p_noise;
)shader_source"
R"shader_source(			if (material_id == kristall_id) {
)shader_source"
R"shader_source(				p_noise = p_kristall;
)shader_source"
R"shader_source(			} else {
)shader_source"
R"shader_source(				p_noise = p;
)shader_source"
R"shader_source(			}
)shader_source"
R"shader_source(			out_color = augenlicht(p_noise, d, normal);
)shader_source"
R"shader_source(		} else if (material_id == kristAlle_id) {
)shader_source"
R"shader_source(			float rough = mk_kristAlle_roughness_rt_float;
)shader_source"
R"shader_source(			float metallic = mk_kristAlle_metallic_rt_float;
)shader_source"
R"shader_source(			fels_color(p, out_color, rough);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(			out_color.rgb = ambientColor(normal, -d, out_color.rgb, rough, metallic);
)shader_source"
R"shader_source(			out_color = mix(out_color, sky_color, pow(smoothstep(200., 300., t), 3.));
)shader_source"
R"shader_source(
)shader_source"
...
R"shader_source(			//if (material_id == fels_id || material_id == berg_id) {
)shader_source"
R"shader_source(				fels_color(p, out_color, rough);
)shader_source"
R"shader_source(			//}
...
R"shader_source(			//out_color = vec3(cellnoise);
)shader_source"
R"shader_source(
)shader_source"
...
R"shader_source(	p_kristall = p_kristall1;
)shader_source"
...
R"shader_source(	vec2 m_kristall = vec2(f_kristall, kristall_id);
)shader_source"
R"shader_source(	vec2 m_kristall2 = vec2(min(kristall2, kristall3), kristall2_id);
)shader_source"
R"shader_source(	return min_material(m_kristall, m_kristall2);
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
...
R"shader_source(	vec2 obj_hintergrund_kristAlle = vec2(f_hintergrund_kristAlle, kristAlle_id);
)shader_source"
R"shader_source(	if (use_bounding) {
)shader_source"
R"shader_source(		obj_fels = min_material(obj_fels, obj_hintergrund_kristAlle);
)shader_source"
R"shader_source(	} else {
)shader_source"
R"shader_source(		obj_fels = smin_material(obj_fels, obj_hintergrund_kristAlle, mk_smin_felsen_rt_float);
)shader_source"
R"shader_source(	}
)shader_source"
R"shader_source(
