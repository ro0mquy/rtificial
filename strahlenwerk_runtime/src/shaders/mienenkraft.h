...
R"shader_source(layout(location = 110) uniform vec3 mk_huegel_pos_rt_vec3;
)shader_source"
R"shader_source(layout(location = 111) uniform float mk_kristall2_r_relative_rt_float;
)shader_source"
R"shader_source(layout(location = 112) uniform float mk_smin_felsen_rt_float;
)shader_source"
R"shader_source(layout(location = 113) uniform vec3 mk_kristall2_trans_relative_rt_vec3;
)shader_source"
R"shader_source(layout(location = 114) uniform float mk_kristall_r_rt_float;
)shader_source"
R"shader_source(layout(location = 115) uniform float mk_bounding_offset_rt_float;
)shader_source"
R"shader_source(layout(location = 116) uniform float mk_hintergrund_kristall_cap_rt_float;
)shader_source"
R"shader_source(layout(location = 117) uniform float mk_hintergrund_kristall_r_rt_float;
)shader_source"
R"shader_source(layout(location = 118) uniform float mk_kristall_cap_rt_float;
)shader_source"
R"shader_source(layout(location = 119) uniform float mk_fog_amount_rt_float;
)shader_source"
R"shader_source(layout(location = 120) uniform float mk_kristall_h_rt_float;
)shader_source"
R"shader_source(layout(location = 121) uniform float mk_bounding_height_rt_float;
)shader_source"
R"shader_source(layout(location = 122) uniform vec3 mk_kristall3_trans_relative_rt_vec3;
)shader_source"
R"shader_source(layout(location = 123) uniform vec3 mk_kristall_pos_rt_vec3;
)shader_source"
R"shader_source(layout(location = 124) uniform float mk_kristall3_h_relative_rt_float;
)shader_source"
R"shader_source(layout(location = 125) uniform float mk_kristall2_h_relative_rt_float;
)shader_source"
R"shader_source(layout(location = 126) uniform vec4 mk_kristall2_rot_relative_rt_quat; // quat
)shader_source"
R"shader_source(layout(location = 127) uniform float mk_fog_invheight_rt_float;
)shader_source"
R"shader_source(layout(location = 128) uniform float mk_hintergrund_kristall_h_rt_float;
)shader_source"
R"shader_source(layout(location = 129) uniform float mk_kristall2_cap_relative_rt_float;
)shader_source"
R"shader_source(layout(location = 130) uniform vec4 mk_kristall3_rot_relative_rt_quat; // quat
)shader_source"
R"shader_source(layout(location = 131) uniform float mk_kristall3_r_relative_rt_float;
)shader_source"
R"shader_source(layout(location = 132) uniform float mk_kristall3_cap_relative_rt_float;
)shader_source"
R"shader_source(layout(location = 133) uniform vec4 mk_kristall_rot_rt_quat; // quat
)shader_source"
...
R"shader_source(		out_color.rgb = vec3(.5);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	} else {
...
R"shader_source(	float f_kristall = kristall(p, mk_kristall_h_rt_float, mk_kristall_r_rt_float, mk_kristall_cap_rt_float);
)shader_source"
R"shader_source(
)shader_source"
