...
layout(location = 58) uniform vec3 sphere1_color; // color
layout(location = 59) uniform vec3 sphere2_color; // color

layout(location = 60) uniform vec3 sphere1_pos; // vec3
