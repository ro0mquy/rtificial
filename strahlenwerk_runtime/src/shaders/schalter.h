...
R"shader_source()shader_source"
R"shader_source(layout(location = 61) uniform float pyramid_h; // float)shader_source"
R"shader_source(layout(location = 62) uniform float pyramid_s; // float)shader_source"
R"shader_source(layout(location = 63) uniform float pyramid_animation; // float)shader_source"
R"shader_source(layout(location = 64) uniform float pyramid_wave_animation; // float)shader_source"
R"shader_source(layout(location = 65) uniform float pyramid_bottom; // float)shader_source"
R"shader_source()shader_source"
R"shader_source(Material materials[5] = Material[5]()shader_source"
R"shader_source(	Material(vec3(.1, .1, .1), .5, 0.),)shader_source"
R"shader_source(	Material(vec3(1.), .5, 0.),)shader_source"
R"shader_source(	Material(vec3(.1,.3,.1), 1., 0.),)shader_source"
R"shader_source(	Material(vec3(.7, .3, .2), 1., 0.),)shader_source"
R"shader_source(	Material(vec3(1.), .5,0.))shader_source"
R"shader_source();)shader_source"
R"shader_source()shader_source"
R"shader_source(#define MATERIAL_ID_FLOOR 0.)shader_source"
R"shader_source(#define MATERIAL_ID_BOUNDING 1.)shader_source"
R"shader_source(#define MATERIAL_ID_PYRAMID 2.)shader_source"
R"shader_source(#define MATERIAL_ID_CUBE 3.)shader_source"
R"shader_source(#define MATERIAL_ID_LIGHTBALL 4.)shader_source"
R"shader_source()shader_source"
R"shader_source(float pyramid(vec3 p, float s, float h);)shader_source"
R"shader_source(float star(vec2 p, float num_wings, float thickness_wings);)shader_source"
R"shader_source()shader_source"
...
R"shader_source(		if (material == MATERIAL_ID_FLOOR) {)shader_source"
R"shader_source(			vec3 col = vec3(0.);)shader_source"
R"shader_source(			float f_col = 0.;)shader_source"
R"shader_source()shader_source"
R"shader_source(			float num_wings = 16.;)shader_source"
R"shader_source(			float thickness_wings = .003;)shader_source"
R"shader_source(			vec3 hit = hit;)shader_source"
R"shader_source(			hit.xz = rot2D(.5 + TAU / 200. * vnoise(hit.xz * .5)) * hit.xz;)shader_source"
R"shader_source()shader_source"
R"shader_source(			f_col = max(f_col, star(rot2D(0.0) * (hit.xz - vec2(  0.,   0.)), num_wings, thickness_wings));)shader_source"
R"shader_source(			f_col = max(f_col, star(rot2D(0.5) * (hit.xz - vec2( 10.,  19.)), num_wings, thickness_wings));)shader_source"
R"shader_source(			f_col = max(f_col, star(rot2D(1.0) * (hit.xz - vec2(-10.,  15.)), num_wings, thickness_wings));)shader_source"
R"shader_source(			f_col = max(f_col, star(rot2D(1.5) * (hit.xz - vec2(  7., -19.)), num_wings, thickness_wings));)shader_source"
R"shader_source(			f_col = max(f_col, star(rot2D(2.0) * (hit.xz - vec2(- 2., - 9.)), num_wings, thickness_wings));)shader_source"
R"shader_source(			f_col = max(f_col, star(rot2D(2.5) * (hit.xz - vec2(- 5.,   4.)), num_wings, thickness_wings));)shader_source"
R"shader_source(			f_col = max(f_col, star(rot2D(3.0) * (hit.xz - vec2(-17., - 3.)), num_wings, thickness_wings));)shader_source"
R"shader_source(			f_col = max(f_col, star(rot2D(3.5) * (hit.xz - vec2( 14., -13.)), num_wings, thickness_wings));)shader_source"
R"shader_source(			f_col = max(f_col, star(rot2D(4.0) * (hit.xz - vec2( 22.,   7.)), num_wings, thickness_wings));)shader_source"
R"shader_source()shader_source"
R"shader_source(			f_col = max(f_col, star(rot2D(.5 + TAU / 100. * vnoise(hit.xz * .5)) * (hit.xz - vec2(- 7.,   4.)), num_wings/2., thickness_wings));)shader_source"
R"shader_source()shader_source"
R"shader_source(			col = vec3(f_col);)shader_source"
R"shader_source(			mat.color = col;)shader_source"
R"shader_source(		})shader_source"
R"shader_source()shader_source"
R"shader_source(		color = apply_light(hit, normal, -direction, mat, SphereLight(vec3(5., 9., 10.), vec3(1.), 2., 100.));)shader_source"
R"shader_source(	})shader_source"
R"shader_source()shader_source"
R"shader_source(	output_color(color, 4.1);// distance(hit, camera_position));)shader_source"
R"shader_source(})shader_source"
R"shader_source()shader_source"
R"shader_source(float star(vec2 p_star, float num_wings, float thickness_wings) {)shader_source"
R"shader_source(	float angle = atan(p_star.x, p_star.y);)shader_source"
R"shader_source(	float length_2 = dot(p_star, p_star);)shader_source"
R"shader_source(	float sin_angle = .5 * (1. - cos(2. * angle * .5 * num_wings)); // sin^2)shader_source"
R"shader_source(	float limit = thickness_wings * num_wings * num_wings / length_2;)shader_source"
R"shader_source(	return 1. - step(limit, sin_angle);)shader_source"
R"shader_source(})shader_source"
R"shader_source()shader_source"
R"shader_source(float pyramid(vec3 p, float s, float h){)shader_source"
...
R"shader_source(	pyr = plane(trans(p, 0.,-h,0.), vec3(0.,-1.,0.));)shader_source"
...
R"shader_source(	float cube = roundbox(q, vec3(linstep(0.,0.1,pyramid_animation)), .5);)shader_source"
R"shader_source(	float d = .75 + smoothstep(.70,1., pyramid_animation)*7.5;)shader_source"
R"shader_source(	float down_anim = - (pyramid_size * pyramid_h + 2. + pyramid_bottom) * smoothstep(0.75, 1., pyramid_animation);)shader_source"
R"shader_source(	float mytorus = torus(trans(q, 0.,-.5 + down_anim,0.), vec2(.5 + d, .5));)shader_source"
R"shader_source(	vec2 schalter_cube = vec2(mix(cube, mytorus, smoothstep(.65, .75, pyramid_animation)), MATERIAL_ID_CUBE);)shader_source"
R"shader_source()shader_source"
...
R"shader_source(	schalter_cube = min_material(schalter_cube, vec2(torus_2, MATERIAL_ID_CUBE));)shader_source"
R"shader_source()shader_source"
...
R"shader_source()shader_source"
R"shader_source(	vec2 bottom = vec2(p.y + 2., MATERIAL_ID_FLOOR);)shader_source"
R"shader_source(	vec2 bounding = vec2(-sphere(p - camera_position, 50.), MATERIAL_ID_BOUNDING);)shader_source"
R"shader_source(	return min_material(smin_material(schalter_cube, bottom, 3.), min_material(lightballs, min_material(pyramid, bounding)));)shader_source"
R"shader_source(})shader_source"
;
#endif
