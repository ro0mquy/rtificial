...
R"shader_source(//uniform float f_stop;
)shader_source"
R"shader_source(
)shader_source"
...
R"shader_source(layout(binding = 9) uniform sampler2D upwards; // vec4
)shader_source"
R"shader_source(layout(binding = 10) uniform sampler2D both; // vec4
)shader_source"
