...
layout(binding = 14) uniform sampler2D color; // vec3
layout(location = 0) out vec3 out_color;
layout(location = 37) uniform float time;

layout(location = 39) uniform float distort_k;
layout(location = 40) uniform float distort_kcube;
layout(location = 41) uniform float vignette_intensity;
layout(location = 42) uniform float grain_freq;
layout(location = 43) uniform float grain_intensity;
