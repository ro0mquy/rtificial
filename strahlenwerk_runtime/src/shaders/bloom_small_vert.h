#ifndef bloom_small_vert_H
#define bloom_small_vert_H
const char bloom_small_vert_source[] =R"shader_source(#version 430)shader_source"
R"shader_source()shader_source"
...
R"shader_source()shader_source"
R"shader_source()shader_source"
R"shader_source(layout(binding = 0) uniform sampler2D color; // vec3 level(2))shader_source"
R"shader_source(layout(location = 0) out vec3 out_color;)shader_source"
R"shader_source()shader_source"
R"shader_source(// level(2))shader_source"
R"shader_source()shader_source"
R"shader_source(void main() {)shader_source"
R"shader_source(	out_color = gaussian(color, tc, vec2(0., 1.), 1./res, 1.);)shader_source"
R"shader_source(})shader_source"
;
#endif
