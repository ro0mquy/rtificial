#ifndef bloom_down_1st_H
#define bloom_down_1st_H
const char bloom_down_1st_source[] =R"shader_source(#version 430
)shader_source"
R"shader_source(
)shader_source"
...
R"shader_source(	out_color = downsample(color, tc, .5/res, true);
)shader_source"
R"shader_source(}
)shader_source"
;
