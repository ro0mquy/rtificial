#ifndef body_H
#define body_H
const char body_source[] =R"shader_source(layout(location = 152) uniform float body_delle_trans_rt_float;
)shader_source"
R"shader_source(layout(location = 153) uniform float body_rings_rt_float;
)shader_source"
R"shader_source(layout(location = 154) uniform float body_deform_rt_float;
)shader_source"
