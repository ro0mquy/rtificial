#ifndef rotator_H
#define rotator_H
const char rotator_source[] =R"shader_source(#version 430
)shader_source"
R"shader_source(layout(location = 230) uniform vec3 lightColor_rt_color; // color
)shader_source"
R"shader_source(layout(location = 231) uniform float aa_rt_float;
)shader_source"
...
R"shader_source(#line 4 "rotator"
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(float fTorusSuperBox(vec3 p, float rBig, float rSmall, float h) {
)shader_source"
R"shader_source(	float t = atan(p.x, p.z);
)shader_source"
R"shader_source(	vec2 q = vec2(f2Sphere(p.xz, rBig), p.y);
)shader_source"
R"shader_source(	h *= sgn(p.z);
)shader_source"
R"shader_source(	//q = p.xz;
)shader_source"
R"shader_source(	//r.x += .5;
)shader_source"
R"shader_source(	float lip = 1.;
)shader_source"
R"shader_source(	if (length(q) < rSmall + .05 * sqrt(2)) {
)shader_source"
R"shader_source(		pRot(q, 2 * (t + h));
)shader_source"
R"shader_source(		lip *= sqrt(4 + square(Pi / (Tau * 2)));
)shader_source"
R"shader_source(	}
)shader_source"
R"shader_source(	float rSmallSmall = rSmall / 8 * 2;
)shader_source"
R"shader_source(	pDomrepAngle(q, 8, rSmall);
)shader_source"
R"shader_source(	if (length(q) < rSmallSmall * sqrt(2))  {
)shader_source"
R"shader_source(		pRot(q, -5 * (t + h));
)shader_source"
R"shader_source(		lip *= sqrt(4 + square(Pi / (Tau * 5)));
)shader_source"
R"shader_source(	}
)shader_source"
R"shader_source(	float d1 = f2Hexprism(q, rSmallSmall) / lip;
)shader_source"
R"shader_source(	return d1;
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(float fTorusSuperBox2(vec3 p, float rBig, float rSmall, float h) {
)shader_source"
R"shader_source(	float t = atan(p.x, p.z);
)shader_source"
R"shader_source(	vec2 q = vec2(f2Hexprism(p.xz, rBig), p.y);
)shader_source"
R"shader_source(	float d1 = f2Hexprism(q, rSmall);
)shader_source"
R"shader_source(	pRot(q, radians(30));
)shader_source"
R"shader_source(	pDomrepAngle(q, 6, rSmall);
)shader_source"
R"shader_source(	float rSmallSmall = rSmall / 6 * .5;
)shader_source"
R"shader_source(	d1 = opSubtractStairs(d1, f2Box(q, rSmallSmall * vec2(3, 1)), rSmallSmall * 3, 4);
)shader_source"
R"shader_source(	return d1;
)shader_source"
R"shader_source(}
...
R"shader_source(float fTorusLine(vec3 p, vec2 r, vec3 v) {
)shader_source"
R"shader_source(	float h = saturate(dot(p, v)/ dot(v, v));
)shader_source"
R"shader_source(	//return fTorusSuperBox(p - v*h, r.x, r.y, h * length(v));
)shader_source"
R"shader_source(	return fTorusSuperBox2(p - v*h, r.x, r.y, h * length(v));
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
...
R"shader_source(	//pMirrorLoco(p.xz, vec2(.5));
)shader_source"
R"shader_source(	////float d = f2Hexprism(p.xy, .8);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	//vec2 dings = pDomrepGrid(p.xz, vec2(7));
)shader_source"
R"shader_source(	//pRotY(p, radians(aa_rt_float * 10));
)shader_source"
R"shader_source(	//pDomrepGrid(p.xz, vec2(15));
)shader_source"
R"shader_source(	//pDomrepRadius(p.xz, 5);
)shader_source"
R"shader_source(	//pMirrorLoco(p.xz, vec2(1));
)shader_source"
R"shader_source(	//float d = fHexprism(p, 1, 2.);
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	//float i = pDomrepRadius(p.xz, 4);
)shader_source"
R"shader_source(	//vec3 p2 = p;
)shader_source"
R"shader_source(	//vec3 p3 = p;
)shader_source"
R"shader_source(	//pRotZ(p, Tau * sin((i - 1)) * .1);
)shader_source"
R"shader_source(	//pRotZ(p2, Tau * sin(i) * .1);
)shader_source"
R"shader_source(	//pRotZ(p3, Tau * sin(i + 1) * .1);
)shader_source"
R"shader_source(	//float d = fTorus(p, vec2(1., .9));
)shader_source"
R"shader_source(	//float d2 = fTorus(p2, vec2(3, .9));
)shader_source"
R"shader_source(	//float d3 = fTorus(p3, vec2(5, .9));
)shader_source"
R"shader_source(	//d = min(d, d2);
)shader_source"
R"shader_source(	//d = min(d, d3);
)shader_source"
R"shader_source(	////d = d2;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	vec3 q = p;
)shader_source"
R"shader_source(	//float d = fTorusLine(q, vec2(1, .5), vec3(3, 0, 0));
)shader_source"
R"shader_source(	float d = fTorusLine(q, vec2(1, .2), vec3(3, 0, 0));
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	//d = min(d, d2);
...
R"shader_source(	mUnion(d, MaterialId(0, p));
)shader_source"
R"shader_source(	return d;
)shader_source"
R"shader_source(}
...
R"shader_source(float sdot(vec3 a, vec3 b) {
)shader_source"
R"shader_source(	return saturate(dot(a, b));
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(float schlick(float f0, float f90, float u) {
)shader_source"
R"shader_source(	return f0 + (f90 - f0) * pow(1. - u, 5.);
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(vec3 schlick(vec3 f0, vec3 f90, float u) {
)shader_source"
R"shader_source(	return f0 + (f90 - f0) * pow(1. - u, 5.);
)shader_source"
R"shader_source(}
...
R"shader_source(float disneyDiffuse(float NdotV, float NdotL, float LdotH, float linearRoughness) {
)shader_source"
R"shader_source(	float energyBias = mix(0., .5, linearRoughness);
)shader_source"
R"shader_source(	float energyFactor = mix(1., 1. / 1.51, linearRoughness);
)shader_source"
R"shader_source(	float fd90 = energyBias + 2. * LdotH * LdotH * linearRoughness;
)shader_source"
R"shader_source(	float lightScatter = schlick(1, fd90, NdotL);
)shader_source"
R"shader_source(	float viewScatter = schlick(1, fd90, NdotV);
)shader_source"
R"shader_source(	return lightScatter * viewScatter * energyFactor / Pi;
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(float G1_GGX(float alpha, float NdotV) {
)shader_source"
R"shader_source(	float tan_theta2 = (1 - square(NdotV)) / square(NdotV);
)shader_source"
R"shader_source(	return (-1 + sqrt(1 + square(alpha) * tan_theta2)) * .5;
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
...
R"shader_source(	vec3 color = normal * .5 + .5;
)shader_source"
R"shader_source(	vec3 lightPos = vec3(0, 0, 5);
)shader_source"
R"shader_source(	vec3 p = hit;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	// pure lambert
)shader_source"
R"shader_source(	//float brdf = 1. / Pi;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	// renormalized disney
)shader_source"
R"shader_source(	vec3 V = -direction;
)shader_source"
R"shader_source(	vec3 L = normalize(lightPos - p);
)shader_source"
R"shader_source(	vec3 H = normalize(L + V);
)shader_source"
R"shader_source(	float NdotV = max(sdot(normal, V), 1e-6);
)shader_source"
R"shader_source(	float NdotL = max(sdot(normal, L), 1e-6);
)shader_source"
R"shader_source(	float NdotH = max(sdot(normal, H), 1e-6);
)shader_source"
R"shader_source(	float VdotH = max(sdot(V, H), 1e-6);
)shader_source"
R"shader_source(	float linearRough = saturate(material.roughness);
)shader_source"
R"shader_source(	//linearRough = smoothFbm(p * vec3(10, 1, .01)) * .5 + .5;
)shader_source"
R"shader_source(	linearRough *= linearRough;
)shader_source"
R"shader_source(	//vec3 brdf = schlick(color, vec3(1), VdotH);
)shader_source"
R"shader_source(	////brdf *= square(linearRough) / (Pi * square(square(NdotH) * (square(linearRough) - 1) + 1));
)shader_source"
R"shader_source(	//brdf /= Pi * square(linearRough) * square(square(NdotH)) * square(1 + (1 - square(NdotH)) / square(NdotH * linearRough));
)shader_source"
R"shader_source(	//brdf /= 1 + G1_GGX(linearRough, NdotV) * G1_GGX(linearRough, NdotL);
)shader_source"
R"shader_source(	//brdf /= 4 * NdotL * NdotV;
)shader_source"
R"shader_source(	////brdf += disneyDiffuse(sdot(normal, V), sdot(L, normal), sdot(L, H), linearRough) * color;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	vec2 coord = vec2(linearRough, NdotL);
)shader_source"
R"shader_source(	vec2 spec_brdf = textureLod(brdf, coord, 0.).rg;
)shader_source"
R"shader_source(	//float brdf_val = disneyDiffuse(NdotV, NdotL, VdotH, linearRough);
)shader_source"
R"shader_source(	float brdf_val = 1./ Pi;
)shader_source"
R"shader_source(	brdf_val *= (1. - spec_brdf.x * .04 - spec_brdf.y);
)shader_source"
R"shader_source(	brdf_val *= .5;
)shader_source"
R"shader_source(	float specular_brdf = schlick(.04, 1., VdotH);
)shader_source"
R"shader_source(	specular_brdf /= Pi * square(linearRough) * square(square(NdotH)) * square(1 + (1 - square(NdotH)) / square(NdotH * linearRough));
)shader_source"
R"shader_source(	specular_brdf /= 1 + G1_GGX(linearRough, NdotV) * G1_GGX(linearRough, NdotL);
)shader_source"
R"shader_source(	specular_brdf /= 4 * NdotL * NdotV;
)shader_source"
R"shader_source(	//brdf_val += specular_brdf;
)shader_source"
R"shader_source(
)shader_source"
R"shader_source(	float illuminance = 1000. / (4. * Pi * dot(lightPos - p, lightPos - p));
)shader_source"
R"shader_source(	return brdf_val * sdot(normalize(lightPos - p), normal) * illuminance * lightColor_rt_color;
)shader_source"
R"shader_source(}
)shader_source"
R"shader_source(
...
R"shader_source(	//mat.roughness = (sin(materialId.coord.y * 30) * .5 + .5) * .3 + .5;
)shader_source"
R"shader_source(	mat.roughness = (smoothNoise(materialId.coord * 3) * .5 + .5) * .3 + .5;
)shader_source"
R"shader_source(	//mat.roughness = aa_rt_float;
)shader_source"
