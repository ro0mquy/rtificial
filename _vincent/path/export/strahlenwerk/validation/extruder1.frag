#version 430
layout(location = 145) uniform float extbg_stripes_indensity_rt_float;
layout(location = 146) uniform vec3 extbg_stripes_color_rt_color; // color
layout(location = 147) uniform float extbg_stripes_width_rt_float;
...
layout(location = 150) uniform vec3 ext3_color_highlight_rt_color; // color
layout(location = 151) uniform float ext1_obj_roughness_rt_float;
layout(location = 152) uniform vec3 ext1_obj_color_rt_color; // color
layout(location = 153) uniform vec2 extbg_stripes_offset_rt_vec2;
layout(location = 154) uniform float ext3_color_highlight_size_rt_float;
layout(location = 155) uniform float ext1_torus_angle_rt_float;
layout(location = 156) uniform float ext1_obj_rot_rt_float;
...
layout(location = 163) uniform vec2 ext1_bez_p2_rt_vec2;
layout(location = 124) uniform vec3 pal_base_rt_color; // color
layout(location = 164) uniform vec2 extbg_stripes_apart_rt_vec2;
...
layout(location = 169) uniform vec2 ext1_bez_p1_rt_vec2;
layout(location = 170) uniform float ext3_color_highlight_roughness_rt_float;
layout(location = 171) uniform bool extbg_enabled_rt_bool;
layout(location = 68) uniform float camera_shake_freq_rt_float;
layout(location = 172) uniform vec2 ext1_bez_p3_rt_vec2;
...
layout(location = 188) uniform float ext1_obj_loco_rt_float;
layout(location = 189) uniform float extbg_tetra_r_rt_float;
layout(location = 190) uniform float ext1_translation_rt_float;
...
layout(location = 194) uniform vec2 ext1_bez_p4_rt_vec2;
layout(location = 195) uniform float ext1_trans_amp_rt_float;
layout(location = 196) uniform float ext1_obj_loco_amp_rt_float;
#line 3
