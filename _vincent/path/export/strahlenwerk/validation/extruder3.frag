...
layout(location = 203) uniform float ext3_color_roughness_rt_float;
layout(location = 204) uniform vec3 ext3_color_spheroid_rt_color; // color
...
layout(location = 205) uniform float ext3_long_trans_rt_float;
...
layout(location = 206) uniform float ext3_long_r_rt_float;
layout(location = 193) uniform float ext_extrude_freq_rt_float;
layout(location = 207) uniform vec2 ext3_bez_p1_rt_vec2;
layout(location = 157) uniform float extlight_1_power_rt_float;
layout(location = 208) uniform vec2 ext3_bez_p3_rt_vec2;
layout(location = 209) uniform vec2 ext3_bez_p4_rt_vec2;
layout(location = 210) uniform vec2 ext3_bez_p2_rt_vec2;
layout(location = 211) uniform float ext3_long_rot_rt_float;
layout(location = 212) uniform float ext3_long_l_rt_float;
#line 3
