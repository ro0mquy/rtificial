#version 430
layout(location = 213) uniform float mandlight_light3_power_rt_float;
layout(location = 214) uniform vec3 mandlight_light3_target_rt_vec3;
layout(location = 215) uniform vec3 mandlight_light3_pos_rt_vec3;
layout(location = 216) uniform vec3 mandlight_light2_color_rt_color; // color
layout(location = 217) uniform float mandlight_light3_angle_rt_float;
layout(location = 218) uniform float mandlight_light2_angle_rt_float;
layout(location = 219) uniform vec3 mandlight_light2_target_rt_vec3;
layout(location = 220) uniform float mandlight_shadow_softness_rt_float;
layout(location = 221) uniform vec3 mand_color_ground_rt_color; // color
layout(location = 222) uniform vec3 mandlight_light1_color_rt_color; // color
...
layout(location = 223) uniform vec3 mandlight_light2_pos_rt_vec3;
layout(location = 224) uniform vec3 mandlight_light1_pos_rt_vec3;
layout(location = 160) uniform float bg_pattern_width_rt_float;
layout(location = 225) uniform vec3 mandlight_light1_target_rt_vec3;
...
layout(location = 227) uniform vec3 mandlight_light3_color_rt_color; // color
...
layout(location = 230) uniform float mandlight_light1_angle_rt_float;
...
layout(location = 232) uniform float mandlight_light1_power_rt_float;
...
layout(location = 238) uniform float mandlight_light2_power_rt_float;
layout(location = 239) uniform float mand_rot_3D_rt_float;
layout(location = 240) uniform float mand_f_domrep_rt_float;
layout(location = 241) uniform float mand_ground_height_rt_float;
#line 3
