...
#include "BRDFLut.h"
	...
	// via https://hero.handmade.network/forums/code-discussion/t/94-guide_-_how_to_avoid_c_c++_runtime_on_windows
	extern "C"
	{
...
const bool use_sound_thread = false;
const int precalc_minimum_time = 100000;
