...
#define _BLANKENHAIN_WRITE_OUT_AUDIO_TO_FILE
#ifdef _BLANKENHAIN_WRITE_OUT_AUDIO_TO_FILE
		HANDLE outputFile;
		do {
		...
		WriteFile(outputFile, audio_buffer, sizeof(float) * MAX_SAMPLES * 2, NULL, NULL);
