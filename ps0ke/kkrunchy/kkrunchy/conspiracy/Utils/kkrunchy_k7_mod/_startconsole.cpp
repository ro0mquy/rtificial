...
rekkrunchy::sInt main( rekkrunchy::sInt argc, rekkrunchy::sChar **argv )
{
  rekkrunchy::sInt ret;

  rekkrunchy::sSystem = new rekkrunchy::sSystem_;
  ret = rekkrunchy::sAppMain( argc, argv );
  delete rekkrunchy::sSystem;
